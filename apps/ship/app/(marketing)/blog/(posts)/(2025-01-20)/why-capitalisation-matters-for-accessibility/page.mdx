...
export const metadata = generateMetadata({
  title: "Why Capitalization Matters for Accessibility",
  description: "Learn how proper capitalization impacts screen readers, readability, and overall accessibility of your web content. Discover best practices for using capitalization to enhance user experience.",
  path: "/blog/why-capitalisation-matters-for-accessibility",
})
...
export const frontmatter = {
  ...
  tags: ["typography", "accessibility", "wcag", "screen-readers", "readability"],
  status: "published",
}
