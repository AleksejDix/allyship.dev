...
export const metadata = generateMetadata({
  title: "Why Swiss Companies Should Care About the European Accessibility Act",
  description: "Learn why Swiss companies need to pay attention to the European Accessibility Act (EAA) and how it affects their business operations in the EU market.",
  path: "/blog/why-swiss-companies-should-care-about-eaa",
})
...
export const frontmatter = {
  ...
  authors: ["Aleksej Dix"],
  category: "Compliance",
  tags: ["eaa", "accessibility", "compliance", "switzerland", "eu", "business"],
  status: "published",
}
