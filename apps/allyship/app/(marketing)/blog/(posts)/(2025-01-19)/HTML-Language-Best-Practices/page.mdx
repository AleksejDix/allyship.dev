...
export const metadata = generateMetadata({
  title: "Why Setting the Correct Language on an HTML Document is Essential",
  ...
  path: "/blog/2025-01-19-HTML-Language-Best-Practices",
})
...
export const frontmatter = {
  ...
  tags: ["html", "accessibility", "wcag", "lang-attribute", "screen-readers", "seo"],
  status: "published",
}
