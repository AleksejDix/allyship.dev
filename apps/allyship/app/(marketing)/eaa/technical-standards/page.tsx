...
export const metadata: Metadata = {
  title:
    'Harmonized Standards & Technical Specifications | European Accessibility Act',
  description:
    'Guidance on the harmonized standards and technical specifications that support compliance with the European Accessibility Act.',
}
