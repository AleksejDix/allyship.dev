        ...
        <div className="space-y-8">
          ...
          <section aria-labelledby="relationship-annexes">
            ...
            <div className="space-y-4">
              ...
              <p>
                For more information about implementation examples, see the
                <Link
          ...
          <section aria-labelledby="market-surveillance">
            ...
            <div className="space-y-4">
              ...
              <p>
                Authorities are likely to scrutinize fundamental alteration
                claims closely, especially when similar products or services in
                the market have successfully implemented the accessibility
                requirements in question.
              </p>
              <p>
                For more information about market surveillance, see the
                <Link
