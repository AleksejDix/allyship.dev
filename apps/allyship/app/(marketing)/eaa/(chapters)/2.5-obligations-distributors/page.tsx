  ...
  return (
    <main tabIndex={-1} id="main-content" className="focus:outline-none">
      ...
      <div className="space-y-8">
        <section aria-labelledby="role-distributors" className="scroll-mt-24">
        ...
        <section aria-labelledby="due-diligence" className="scroll-mt-24">
        ...
        <section
          aria-labelledby="manufacturer-obligations"
          className="scroll-mt-24"
        >
          <h2
            className="text-2xl font-semibold mb-4"
        ...
        <section
          aria-labelledby="accessible-information"
          className="scroll-mt-24"
        >
          <h2
            className="text-2xl font-semibold mb-4"
        ...
        >
          <Link
            href="/eaa/2.4-obligations-importers"
