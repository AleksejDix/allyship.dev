  ...
  return (
    <>
      <div className="space-y-8">
        ...
        <section>
          ...
          <div className="prose max-w-none">
            <p>
              ...
              meeting the accessibility requirements outlined in Annex I. These
              examples serve as practical guidance for economic operators
            ...
            <p>
              This page presents these examples organized by product and service
              categories, along with additional context and explanations to help
        ...
        <section>
          <h2 className="text-2xl font-semibold mb-4" id="legal-status">
          ...
          <div className="prose max-w-none">
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                <strong>Non-binding guidance:</strong> The examples provided are
                illustrative, not prescriptive requirements
              </li>
              <li>
                <strong>Alternative approaches:</strong> Economic operators can
                implement different solutions that meet the accessibility
                requirements
              </li>
              <li>
            ...
            <p>
              ...
              assess whether the accessibility requirements are met, not whether
              specific examples from Annex II were followed.
            </p>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="prose max-w-none">
            ...
            <p>Annex II provides examples for making information accessible:</p>
            <ul className="list-disc pl-6 space-y-2">
              <li>
                <strong>Visual information:</strong> Providing text alternatives
                that can be recognized by assistive technologies, such as screen
                readers
              </li>
              <li>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                <strong>Keyboard operability:</strong> Making all functionality
                available through keyboard interfaces, including for actions
                that typically require complex gestures
              </li>
              <li>
        ...
        <section>
          <h2 className="text-2xl font-semibold mb-4" id="product-specific">
          ...
          <div className="prose max-w-none">
            ...
            <p>Examples for computer hardware and operating systems include:</p>
            <ul className="list-disc pl-6 space-y-2">
              <li>
                <strong>Hardware identification:</strong> Providing tactile
                markings on keys and controls to enable identification by touch
              </li>
              <li>
                <strong>Operating system interfaces:</strong> Offering
                text-to-speech functionality, screen reader support, and screen
                magnification
              </li>
              <li>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                <strong>Voice output:</strong> Providing spoken instructions and
                feedback when a user interacts with the device
              </li>
              <li>
                <strong>Physical accessibility:</strong> Allowing for headphone
                connection to receive voice guidance privately and securely
              </li>
              <li>
                <strong>Input flexibility:</strong> Allowing users to adjust the
                time during which inputs are valid, or to confirm inputs before
                finalizing
              </li>
              <li>
              ...
              <li>
                <strong>Operational consistency:</strong> Ensuring that keypads
                have a standard layout with tactile indicators
              </li>
            </ul>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                <strong>Navigation:</strong> Supporting keyboard navigation and
                structured content to enable navigation by chapter, section, or
                page
              </li>
              <li>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                ...
                readers, voice control, switch control, and other accessibility
                features
              </li>
            </ul>
          </div>
        ...
        <section>
          <h2 className="text-2xl font-semibold mb-4" id="service-specific">
          ...
          <div className="prose max-w-none">
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                <strong>Product filters:</strong> Including accessible filtering
                options for product searches
              </li>
            </ul>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                <strong>Statement access:</strong> Providing bank statements in
              ...
              <li>
                ...
                layouts and navigation patterns across digital banking services
              </li>
            </ul>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                <strong>User controls:</strong> Providing accessible mechanisms
                to enable, disable, or adjust accessibility features
              </li>
            </ul>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                <strong>Image descriptions:</strong> Providing alternative text
                for all informative images
              </li>
              <li>
                <strong>MathML:</strong> Using Mathematical Markup Language for
                accessible representation of mathematical formulas
              </li>
              <li>
                <strong>EPUB format:</strong> Providing content in EPUB3 format
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                <strong>Ticketing services:</strong> Ensuring that online ticket
                purchasing and digital tickets are accessible
              </li>
              <li>
        ...
        <section>
          <h2 className="text-2xl font-semibold mb-4" id="technical-solutions">
          ...
          <div className="prose max-w-none">
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                <strong>Semantic HTML:</strong> Using appropriate HTML elements
                for their intended purpose (headings, lists, tables, forms)
              </li>
              <li>
              ...
              <li>
                <strong>Form validation:</strong> Providing clear error messages
                and suggestions for correction
              </li>
              <li>
                <strong>Responsive design:</strong> Creating layouts that adapt
                to different screen sizes and zoom levels
              </li>
            </ul>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                <strong>Touch target size:</strong> Making interactive elements
                large enough for users with motor impairments
              </li>
              <li>
                <strong>Gesture alternatives:</strong> Providing alternative
                means to perform actions that typically require complex gestures
              </li>
              <li>
              ...
              <li>
                <strong>Consistent navigation:</strong> Maintaining predictable
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                <strong>Tagged PDF:</strong> Creating PDFs with proper structure
                tags for headings, lists, tables, and reading order
              </li>
              <li>
                <strong>Word processing:</strong> Using built-in heading styles,
                alternative text for images, and proper table structure
              </li>
              <li>
                <strong>Spreadsheets:</strong> Adding header rows, avoiding
                blank cells for formatting, and providing text alternatives for
                charts
              </li>
              <li>
        ...
        <section>
          ...
          <div className="prose max-w-none">
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                Consider how examples apply to different types of content within
                the same product (e.g., text, images, interactive elements)
              </li>
              <li>
          ...
          <div className="prose max-w-none">
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                ...
                viable approaches but not necessarily the most optimal solutions
                for all contexts
              </li>
              <li>
                <strong>Integration challenges:</strong> Real-world
                implementation often requires integrating multiple examples and
                approaches
              </li>
              <li>
        ...
        <section>
          <h2 className="text-2xl font-semibold mb-4" id="relationship">
        ...
        <section>
          <h2 className="text-2xl font-semibold mb-4" id="resources">
          ...
          <div className="prose max-w-none">
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                ...
                documentation provided by major platform vendors (Apple, Google,
                Microsoft)
              </li>
              <li>
            ...
            <p>
              These resources can help expand on the examples provided in Annex
              II, offering more detailed technical guidance and
              industry-specific applications.
            </p>
          </div>
        </section>
