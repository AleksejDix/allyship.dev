      ...
      <div className="space-y-8">
        <section>
          ...
          <div className="prose max-w-none">
            <p>
              ...
              the directive. These requirements aim to ensure that persons with
              disabilities can access and use products and services on an equal
              basis with others.
            </p>
            <p>
              The requirements are organized into sections for different types
              of products and services, with both general requirements
              applicable to all products and services and specific requirements
          ...
          <div className="prose max-w-none">
            ...
            <ol className="pl-6 space-y-4">
              <li>
                ...
                <ul>
                  <li>Are perceivable through more than one sensory channel</li>
              ...
              <li>
                ...
                interface, including operation, controls, and feedback, must be
                made accessible by:
                <ul>
                  <li>
                  ...
                  <li>
                    Avoiding triggering seizures and allowing adequate time for
                    interactions
                  </li>
                  <li>
              ...
              <li>
                <strong>Support Services:</strong> Support services (helpdesks,
                call centers, etc.) must provide information about the product's
                accessibility in accessible modes of communication.
              </li>
            </ol>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="prose max-w-none">
            ...
            <ul>
              ...
              <li>
                Provide instructions for installation, maintenance, storage, and
                disposal in accessible formats
              </li>
              <li>Present safety information in accessible multiple formats</li>
            </ul>
            ...
            <ul>
              <li>
                Include text-to-speech functionality when the terminal has text
                input/output
              </li>
              <li>
            ...
            <p>
              Terminal equipment with interactive computing capability used for
              accessing audiovisual media services must make those components
              needed for access available to persons with disabilities.
            </p>
          </div>
        </section>
            ...
            <ol className="pl-6 space-y-4">
              ...
              <li>
                ...
                <ul>
                  ...
                  <li>Including a statement about accessibility compliance</li>
                  <li>
              ...
              <li>
                ...
                <ul>
                  <li>
                    Providing information about the service's accessibility and
        ...
        <section>
          ...
          <div className="prose max-w-none">
            ...
            <h3 className="text-xl font-semibold mt-6 mb-2" id="transportation">
            ...
            <ul>
              ...
              <li>
                Ensure information is understandable with a complexity level not
                exceeding level B2 (upper intermediate) of the Council of
        ...
        <section>
          <h2 className="text-2xl font-semibold mb-4" id="compliance-criteria">
            Criteria for Functional Performance
          </h2>
          <div className="prose max-w-none">
            <p>
              Annex I also establishes functional performance criteria to serve
              as guidelines when the technical requirements don't address
              specific features or functions. These criteria ensure that
              products and services must be usable by persons:
            </p>
            <ul>
        ...
        <section>
          ...
          <div className="prose max-w-none">
            ...
            <p>
              ...
              monitoring compliance with the accessibility requirements and can
              perform checks to verify conformity.
            </p>
          </div>
        </section>
