...
-- Create function with proper column names to avoid ambiguity
...
BEGIN
  ...
  -- Explicit column names in RETURN QUERY to prevent ambiguity
  RETURN QUERY
  SELECT v_scan_id AS scan_id, v_status AS scan_status, v_created_at AS scan_created_at;
