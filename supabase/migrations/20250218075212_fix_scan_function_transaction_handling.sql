...
-- Recreate the function without explicit transaction management
...
BEGIN
  ...
  -- Return the results using the variables directly instead of a SELECT
  RETURN NEXT v_scan_id, v_status, v_created_at;
  RETURN;
