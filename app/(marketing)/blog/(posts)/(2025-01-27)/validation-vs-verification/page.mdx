...
export const metadata = generateMetadata({
  title: "Validation vs. Verification in Software Testing",
  description: "Understand the key differences between validation and verification in software testing, and how they contribute to building high-quality, accessible software.",
  path: "/blog/validation-vs-verification",
})
...
export const frontmatter = {
  ...
  authors: ["Aleksej Dix"],
  category: "Testing",
  tags: ["testing", "quality-assurance", "validation", "verification", "software-development"],
  status: "published",
}
