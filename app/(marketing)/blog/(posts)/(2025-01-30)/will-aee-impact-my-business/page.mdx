...
export const metadata = generateMetadata({
  ...
  description: "Understand how the European Accessibility Act (EAA) affects businesses and what steps you need to take to ensure compliance with digital accessibility requirements.",
  path: "/blog/will-aee-impact-my-business",
})
...
export const frontmatter = {
  ...
  authors: ["Aleksej Dix"],
  category: "Compliance",
  tags: ["eaa", "accessibility", "compliance", "legislation", "business", "europe"],
  status: "published",
}
