...
export const metadata = generateMetadata({
  ...
  description: "Learn the fundamentals of web accessibility, why it matters, and how to make your website more accessible for all users.",
  path: "/blog/introduction-into-web-accessibility",
})
...
export const frontmatter = {
  ...
  tags: ["accessibility", "wcag", "a11y", "introduction", "aria", "html"],
  status: "published",
}
