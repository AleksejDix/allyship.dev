...
export const metadata = generateMetadata({
  title: "The 7 Principles of Accessible Software Testing",
  description: "Explore the seven fundamental principles that guide accessible software testing, ensuring your applications work for all users regardless of their abilities.",
  path: "/blog/7-principles-of-accessible-software-testing",
})
...
export const frontmatter = {
  ...
  authors: ["Aleksej Dix"],
  category: "Testing",
  tags: ["testing", "accessibility", "wcag", "principles", "software-development", "quality-assurance"],
  status: "published",
}
