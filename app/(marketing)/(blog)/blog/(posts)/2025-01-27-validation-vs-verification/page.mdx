...
export const metadata = {
  title: 'Verification and Validation: What’s the Difference?',
  description: 'Learn the difference between verification and validation in software testing, and how WCAG ensures accessibility for all users.',
}
